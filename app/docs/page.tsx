  ...
  return (
    <main className="max-w-3xl mx-auto p-6">
      ...
      <ul className="list-disc pl-6">
        <li className="mb-2">
          <Link href="/api/seasons" className="text-blue-500">
            /api/seasons
          </Link>
        ...
        <li className="mb-2">
          <Link href="/api/drivers/{year}" className="text-blue-500">
            /api/drivers
          </Link>
          : Retrieve a list of all the Drivers who at least race one F1 race.
        </li>
        <li className="mb-2">
          <Link href="/api/teams/{year}" className="text-blue-500">
            /api/teams
          </Link>
        ...
        <li className="mb-2">
          <Link href="/api/results/{year}/{round}" className="text-blue-500">
            /api/circuits
          </Link>
