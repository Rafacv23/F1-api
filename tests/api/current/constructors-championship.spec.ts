...
test.describe("GET /api/current/constructors-championship", async () => {
  test("should return teams championships by the current year", async ({
    request,
  }) => {
    const response = await request.get(`/api/current/constructors-championship`)
