...
test.describe("GET /api/[year]/drivers-championship", async () => {
  test("should return drivers championships by the year provided", async ({
    request,
  }) => {
    const response = await request.get(`/api/2024/drivers-championship`)
