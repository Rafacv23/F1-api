...
export const driverClassifications = sqliteTable("Driver_Classifications", {
  ...
  championshipId: text("Championship_ID", { length: 200 }).references(
    () => championships.championshipId
  ),
  driverId: text("Driver_ID", { length: 200 }).references(
    () => drivers.driverId
  ),
...
export const constructorsClassifications = sqliteTable(
...
export const circuits = sqliteTable("Circuits", {
  ...
  fastestLapDriverId: text("Fastest_Lap_Driver_ID", { length: 200 }).references(
    () => drivers.driverId
  ),
  fastestLapTeamId: text("Fastest_Lap_Team_ID", { length: 255 }).references(
    () => teams.teamId
  ),
...
export const races = sqliteTable("Races", {
  ...
  championshipId: text("Championship_ID", { length: 100 }).references(
    () => championships.championshipId
  ),
  ...
  laps: integer("Laps"),
  winnerId: text("Winner_ID", { length: 200 }).references(
    () => drivers.driverId
  ),
  teamWinnerId: text("Team_Winner_ID", { length: 255 }).references(
    () => teams.teamId
  ),
  url: text("Url", { length: 400 }),
  round: integer("Round"),
